...
sites: tuple[_News, ...] = tuple(site(tuple(_j_urls[site.__name__]["urls"])) for cls in _base_classes for site in cls.__subclasses__() if site not in _base_classes and _j_urls[site.__name__]["active"])
print(len(sites))
